    ...
    <div className="relative" ref={searchRef}>
      ...
      <div className="relative">
        <div className="flex items-center space-x-2">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 text-[#4338CA] transform -translate-y-1/2 text-gray-400 w-4 h-4" />
            <input
              type="text"
              ...
              className="placeholder:text-[#4338CA] w-64 md:w-96 pl-10 pr-4 py-2 border border-[#4338CA] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            {searchQuery && (
              <button
                onClick={() => {
      ...
      {isOpen && (searchQuery || searchResults.length > 0) && (
        <div className="absolute top-full left-0 mt-2 w-80 md:w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-[100] max-h-96 overflow-y-auto">
          {loading ? (
