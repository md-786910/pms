...
const AdvancedSearch = () => {
  ...
  return (
    <div className="relative z-[10000]" ref={searchRef}>
      {/* Search Input */}
        ...
        <div className="flex items-center space-x-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-64 md:w-80 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            />
            {searchQuery && (
              <button
                onClick={() => {
      ...
      {isOpen && (searchQuery || searchResults.length > 0) && (
        <div className="absolute top-full left-0 mt-2 w-80 md:w-96 bg-white rounded-xl shadow-2xl border border-slate-200/50 z-[10000] max-h-96 overflow-y-auto">
          {loading ? (
